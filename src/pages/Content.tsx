...
const Content = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-green-300 to-green-500 p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <Input
              type="text"
              placeholder="მოძებნე მოსწავლეები"
              value={searchTerm}
      ...
      <div className={`max-w-7xl mx-auto transition-all duration-500 ${isExpanded ? 'opacity-0 pointer-events-none' : ''}`}>
        <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-8">
          ...
          <div className="flex gap-4 order-1 md:order-2 w-full md:w-auto justify-between md:justify-end">
            <a
